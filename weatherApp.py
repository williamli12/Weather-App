...
#key = "7c09aa5eb03843715cfb89414fc956d0" #my api key
...
def generateLatLong():
    ...
    if cName != None:
        ...
        url = f"http://api.openweathermap.org/geo/1.0/direct?q={cName}&limit={choiceLimit}&appid=7c09aa5eb03843715cfb89414fc956d0"
        r = requests.get(url)
        dataList = r.json()
...
def userInput():
    ...
    question = st.radio("Do you want to input your own coordinates or choose a random city?", answer, index=None)
    ...
    if enterButton:
        if question == answer[2]:
            lat = atup[0]
            long = atup[1]
        weatherURL = f"https://api.openweathermap.org/data/2.5/weather?lat={lat}&lon={long}&appid=7c09aa5eb03843715cfb89414fc956d0"
